...
if __name__ == '__main__':
    ...
    Examples of errors
    '''
    # game.play('12345', allow_custom_words = True) # contains digits so raises a ValueError
    ...
    '''
    game.play('magazine', num_guesses = 7, allow_custom_words = True)  # is not valid so defaults to a random word
